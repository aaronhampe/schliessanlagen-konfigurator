export default {
    ...
    Knaufzylinder: {
        sizes: [
            ...
            ////////
            { outside: 35, inside: 30, price: 100.75 },
            ...
            ////////
            { outside: 40, inside: 30, price: 109.15 },
            { outside: 40, inside: 35, price: 113.35 },
            ...
            ////////
            { outside: 45, inside: 30, price: 113.35 },
            { outside: 45, inside: 35, price: 117.55 },
            { outside: 45, inside: 40, price: 121.75 },
            ...
            ////////
            { outside: 50, inside: 30, price: 117.55 },
            { outside: 50, inside: 35, price: 121.75 },
            { outside: 50, inside: 40, price: 125.95 },
            { outside: 50, inside: 45, price: 129.10 },
            ...
            ////////
            { outside: 55, inside: 30, price: 121.75 },
            { outside: 55, inside: 35, price: 125.95 },
            { outside: 55, inside: 40, price: 129.10 },
            { outside: 55, inside: 45, price: 133.30 },
            ...
            ////////
            { outside: 60, inside: 30, price: 125.95 },
            { outside: 60, inside: 35, price: 129.10 },
            { outside: 60, inside: 40, price: 133.30 },
            { outside: 60, inside: 45, price: 137.50 },
            { outside: 60, inside: 50, price: 141.70 },
            { outside: 60, inside: 55, price: 145.90 },
            { outside: 60, inside: 60, price: 150.10 },
            { outside: 60, inside: 65, price: 154.30 },
            { outside: 60, inside: 70, price: 158.50 },
            ////////
            { outside: 65, inside: 30, price: 129.10 },
            { outside: 65, inside: 35, price: 133.30 },
            { outside: 65, inside: 40, price: 137.50 },
            { outside: 65, inside: 45, price: 141.70 },
            { outside: 65, inside: 50, price: 145.90 },
            { outside: 65, inside: 55, price: 150.10 },
            { outside: 65, inside: 60, price: 154.30 },
            { outside: 65, inside: 65, price: 158.50 },
            { outside: 65, inside: 70, price: 162.70 },
            ////////
            { outside: 70, inside: 30, price: 133.30 },
            { outside: 70, inside: 35, price: 137.50 },
            { outside: 70, inside: 40, price: 141.70 },
            { outside: 70, inside: 45, price: 145.90 },
            { outside: 70, inside: 50, price: 150.10 },
            { outside: 70, inside: 55, price: 154.30 },
            { outside: 70, inside: 60, price: 158.50 },
            { outside: 70, inside: 65, price: 162.70 },
