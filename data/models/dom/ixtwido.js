export default {
    ...
    Halbzylinder: {
        ...
        sizes: [
            { inside: 10, outside: 30, price: 55.60 },
            { inside: 10, outside: 35, price: 61.90 },
            { inside: 10, outside: 40, price: 61.90 },
            { inside: 10, outside: 45, price: 67.15 },
            { inside: 10, outside: 50, price: 67.15 },
            { inside: 10, outside: 55, price: 72.40 },
            { inside: 10, outside: 60, price: 72.40 },
            { inside: 10, outside: 65, price: 78.70 },
            { inside: 10, outside: 70, price: 78.70 },
        ],
        options: [
            "Not- & Gefahrenfunktion",
            "Modulare Bauweise",
