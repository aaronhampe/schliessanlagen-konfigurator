...
Der R6 verfügt ab einer Länge von 30-30 auf jeder Schließseite über 6 Codierstifte aus verschleißfestem Spezialmessing. Im Profilzylinder sind sowohl ein Bohrschutz als auch ein Pickingschutz integriert. Das Zylindergehäuse ist standardmäßig matt vernickelt oder aus Messing gefertigt. Die Schlüssel bestehen aus vernickeltem Messing.`,
    ...
    Halbzylinder: {
        sizes: [
            { inside: 10, outside: 30, price: 28.36 },
            { inside: 10, outside: 35, price: 28.36 },
            { inside: 10, outside: 40, price: 29.42 },
            { inside: 10, outside: 45, price: 30.47 },
            { inside: 10, outside: 50, price: 30.47 },
            { inside: 10, outside: 55, price: 31.52 },
            { inside: 10, outside: 60, price: 32.57 },
            { inside: 10, outside: 65, price: 32.57 },
            { inside: 10, outside: 70, price: 33.63 },
            { inside: 10, outside: 75, price: 33.63 },
            { inside: 10, outside: 80, price: 34.68 },
            { inside: 10, outside: 85, price: 34.68 },
            { inside: 10, outside: 90, price: 36.78 },
        ],
        options: [
